...
Spam = np.array(sorted(np.random.geometric(0.9, 2000)))
...
print("R^2 первой линейной регрессии равен:", scipy.stats.linregress(Money, Subs)[2] ** 2)
...
print("R^2 второй линейной регрессии равен:", scipy.stats.linregress(Spam, Subs)[2] ** 2)
...
print("R^2 третьей линейной регрессии равен:", scipy.stats.linregress(Work, Subs)[2] ** 2)
